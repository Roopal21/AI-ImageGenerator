...
const OPENAI_API_KEY ="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"; // Your OpenAI API key here
...
const handleImageGeneration = (e) => {
  ...
  const userImgQuantity = parseInt(generateForm.querySelector('.img-quantity').value);
